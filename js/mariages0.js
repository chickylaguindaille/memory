...
*/
/*extraire 14 entiers dans l'ensemble [1..21]*/
var lesNuméros = [];
for (var i = 1; i <= 21; i++) 
{
	lesNuméros.push(i);
...
{
	var unNuméroAléatoire = (Math.floor(Math.random() * (21))+1);
	var existe = 0;
...
for (var i = 0; i < 14; i++) 
{
	...
	var nomFichier = './images/bibi/'+(lesNumérosRetenus[i])+'.jpg';
...
for (var i = 14; i < 28; i++) 
{
	...
	var recto = document.createElement('img');
	var nomFichier = './images/bibi/'+(lesNumérosRetenus[i-14])+'.jpg';
	// var nomFichier = './images/'+((i%14)+1)+'.jpg';
	//console.log(nomFichier);
	recto.src = nomFichier;
	carte.recto = recto;
